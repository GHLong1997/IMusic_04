...
import com.hangoclong.music.service.PlayMusicService;
...
public class PlayMusicFragment extends BaseFragment
    ...
    private RelativeLayout mLinearBottomParentActivity;
    ...
    private void initViews(View view) {
        mLinearBottomParentActivity = getActivity().findViewById(R.id.relative_bottom);
    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        public void run() {
            ...
            if (currentPosition.equals(totalTime)
                    ...
                    && mSetup.equals(Constant.NON_REPEAT) && currentDuration != 0) {
                ...
                lastNonTrack = true;
                return;
            } else if (currentPosition.equals(totalTime) && currentDuration != 0) {
