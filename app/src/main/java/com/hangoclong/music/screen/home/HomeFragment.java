...
import com.hangoclong.music.data.source.local.TrackLocalDataSource;
import com.hangoclong.music.data.source.remote.TrackRemoteDataSource;
import com.hangoclong.music.screen.BaseFragment;
import com.hangoclong.music.screen.EndlessRecyclerViewScrollListener;
import com.hangoclong.music.screen.playmusic.PlayMusicFragment;
import com.hangoclong.music.utils.Constant;
import com.hangoclong.music.utils.common.ConnectionUtils;
...
public class HomeFragment extends BaseFragment
        implements HomeContract.View, ViewPager.OnPageChangeListener,
    ...
    private List<SliderFragment> mTrendingSliderFragmentList;
    ...
    private HomeAdapter mAdapterRock, mAdapterAmbient, mAdapterClassical, mAdapterCountry;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mPresenter = new HomePresenter(trackRepository);
    ...
    public void showSlider(List<Track> trackList) {
        ...
        for (Track track : trackList) {
            mTrendingSliderFragmentList.add(SliderFragment.newInstance(track));
        }
        SliderAdapter trendingTrackViewPager =
    ...
    public void showAlternativeTrackList(Collection collection) {
        ...
        mAdapterRock = new HomeAdapter(getContext(), this);
    ...
    public void showAmbientTrackList(Collection collection) {
        ...
        mAdapterAmbient = new HomeAdapter(getContext(), this);
    ...
    public void showClassicalTrackList(Collection collection) {
        ...
        mAdapterClassical = new HomeAdapter(getContext(), this);
    ...
    public void showCountryTrackList(Collection collection) {
        ...
        mAdapterCountry = new HomeAdapter(getContext(), this);
