...
public final class Constant {
    ...
    public static final String TRACK_GENRES_URL = BASE_URL + "/tracks?client_id="
            + BuildConfig.API_KEY + "&genres=";
    public static final String MUSIC_SEARCH_URL = BASE_URL + "/tracks?client_id="
            + BuildConfig.API_KEY + "&q=";
